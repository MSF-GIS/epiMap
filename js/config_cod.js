...
var configFile = {
    ...
    data : {
        analysisLayer : {
            geometry : {
                name    : "Zones de Santé",                
                source  : "data/cod_hltbnd_lvl2_a_msf_2.json",
                format  : "",
                // Joined field ('p' code).
                geoCode : "pcode",
            ...
            geometryPoints : {
                name    : "Zones de Santé",                
                source  : "data/cod_hltbnd_lvl2_a_msf_CENTROIDS.json",
                format  : "",
                // Joined field ('p' code).
                geoCode : "pcode",
                // Matching names for labels.
...
//                source : "data/export_yemcholera.csv",
                source : "data/IDS_2012_codcholera.csv",
                delimiter : ";",
        ...
        otherLayers : [
            {
                ...
                source  : "data/cod_hltbnd_lvl3_a_rgc.json",
                style   : {
    ...
    analysisFunctions : {
        ...
        types : {
            ...
            cases : {
                titleForLegend : "Cases (by zones de santé)",
                fill : {
         ...
         */
        analysis_1 : {
            class1_less     :   {value : 2,             color : "rgb(254,229,217)"},
            class2_between  :   {value : [2, 5],       color : "rgb(252,187,161)"},
            class3_between  :   {value : [5, 10],      color : "rgb(252,146,114)"},
            class4_between  :   {value : [10, 15],     color : "rgb(251,106,74)"},
            class5_between  :   {value : [15, 20],    color : "rgb(222,45,38)"},
            class6_more     :   {value : 20,           color : "rgb(165,15,21)"}
        },
        analysis_2 : {
            class1_less     :   {value : 5,             color : "rgb(254,229,217)"},
            class2_between  :   {value : [5, 25],       color : "rgb(252,187,161)"},
            class3_between  :   {value : [25, 50],      color : "rgb(252,146,114)"},
            class4_between  :   {value : [50, 75],     color : "rgb(251,106,74)"},
            class5_between  :   {value : [75, 100],    color : "rgb(222,45,38)"},
            class6_more     :   {value : 100,           color : "rgb(165,15,21)"}
        },
        legendParam : {
