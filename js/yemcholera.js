...
/* global configFile, ol, d3, Infinity, dc, noUiSlider, moment, analysisType, analysisAbsoluteField, analysisField */
...
//        });
        ...
        analysisLayer.getSource().addFeatures(TopoJsonFormat.readFeatures(data2));
        ...
        analysisLayerPoints.getSource().addFeatures(TopoJsonFormat.readFeatures(data));
...
setExportPdf();
	...
	sliderWidth.noUiSlider.on('update', function(value){
        ...
        error: function(){console.log("error : counldn't retrieve data from repository");}		
        });
    });
});